const Icon = ({ name, size = 18, color = "currentColor", ...props }) => {
    const paths = {
        ...
        target:    <><circle cx="12" cy="12" r="10" stroke={color} strokeWidth="1.5" fill="none"/><circle cx="12" cy="12" r="6" stroke={color} strokeWidth="1.5" fill="none"/><circle cx="12" cy="12" r="2" fill={color}/></>,
